...
class Trainer(object):
    ...
    def get_train_iterator(
        ...
        #print("self.task.max_positions() " + str(self.task.max_positions()))
        #print("self.model.max_positions() " + str(self.model.max_positions()))
        #print("self.args.max_tokens" + str(self.args.max_tokens))
        ...
        return self.task.get_batch_iterator(
            ...
            max_positions=utils.resolve_max_positions(
                ...
                (self.args.max_tokens, self.args.max_tokens),
            ),
